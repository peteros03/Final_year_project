    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('gatekeeper', 'Gatekeeper'), ('teacher', 'Teacher'), ('registrar', 'Registrar'), ('finance', 'Finance')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finance_status', models.CharField(choices=[('Paid', 'Paid'), ('Pending', 'Pending'), ('Unpaid', 'Unpaid')], default='Pending', max_length=7)),
                ('campus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='students.campus')),
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='students.college')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='students.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance_type', models.CharField(choices=[('Class', 'Class'), ('Exam', 'Exam')], max_length=10)),
